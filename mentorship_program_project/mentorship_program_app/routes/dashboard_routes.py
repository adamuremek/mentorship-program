...
def dashboard(req):
    ...
    if opposite_role == "Mentor":
        ...
        requester_accounts = MentorshipRequest.objects.filter(requester=session_user.mentee.account.id)
    ...
    if opposite_role == "Mentee":
        ...
        requester_accounts = MentorshipRequest.objects.filter(requester=session_user.mentor.account.id)
