    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('strRole', models.CharField(choices=[('Admin', 'Admin'), ('Mentor', 'Mentor'), ('Mentee', 'Mentee'), ('MentorPending', 'Mentor Pending'), ('Graduated', 'Graduated'), ('Declined', 'Declined')], default='', max_length=15)),
