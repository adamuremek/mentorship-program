# Generated by Django 5.0.1 on 2024-03-11 00:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('img_profile', models.ImageField(default='images/default_profile_picture.png', upload_to='images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('str_title', models.CharField(max_length=100)),
                ('str_body', models.CharField(max_length=7000)),
                ('cls_created_on', models.DateField(default=datetime.date.today)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('mentee', 'mentor'), name='unique_mentorship_request_constraint'),
        ),
    ]
